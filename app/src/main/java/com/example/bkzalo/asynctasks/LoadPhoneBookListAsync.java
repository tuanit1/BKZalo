...
public class LoadPhoneBookListAsync extends AsyncTask<Void, String, Boolean> {
    private RequestBody requestBody;
    private PhoneBookListListener listener;
    private ArrayList<User> arrayList_user;

    public LoadPhoneBookListAsync(RequestBody requestBody, PhoneBookListListener listener) {
