...
public class LoadMessagesAsync extends AsyncTask<Void, String, Boolean> {

    private RequestBody requestBody;
    private LoadMessagesListener listener;
    private ArrayList<Message> arrayList_message;

    public LoadMessagesAsync(RequestBody requestBody, LoadMessagesListener listener) {
